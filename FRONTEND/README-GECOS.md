...
```css
--primary: #b90a0a /* Rojo corporativo */ --primary-dark: #8f0606
  /* Hover states */ --green-500: #10b981 /* Disponible */ --yellow-500: #eab308
  /* Ocupado/Próximo */ --red-500: #ef4444 /* Mantenimiento */
...
- [x] Sistema de permisos (admin/docente)
